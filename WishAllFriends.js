            ...
            if (birthdayCount > 0) {
                ...
                for (let i = 0; i < birthdayCount; i++) {
                    ...
                    try {
                        ...
                        await newTab.click("div[class='rq0escxv datstx6m k4urcfbm a8c37x1j']");
                        if (todayRecentBirthday[i] == "Today's Birthdays") {
                            content = "Happy Birthday " + nameArr[i] + " 🎂🎉";
                        } else {
                            content = "Belated Happy Birthday " + nameArr[i] + " 🎂🎉";
                        }

                        await newTab.type("div[class='rq0escxv datstx6m k4urcfbm a8c37x1j']", content, {
                            delay: 100
                        });
                        await newTab.keyboard.down('Enter');
                        await newTab.keyboard.up('Enter');
                        ...
                        //Create Excel File
                        createExcelExecutorFn(jsonContent);
                ...
                console.log("Thanks for visiting!! None of your friends have birthday today or in the recent past");
                console.log("END...");
                await newTab.close();
            }
        } catch (error) {
            console.log("Thanks for visiting!! You have already sent a happy birthday message to all of your friends.");
            console.log("END...");
